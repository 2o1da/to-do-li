...
class ListViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.monthLabel.text = df.string(from: calendarView.currentPage)
        self.monthLabel.font = UIFont.systemFont(ofSize: 20, weight: .bold)
        self.dateLabel.font = UIFont.systemFont(ofSize: 26, weight: .bold)
        self.weekLabel.font = UIFont.systemFont(ofSize: 14, weight: .regular)
...
//        topView.layer.masksToBounds = false
        ...
        self.view.addSubview(calendarSegmentedControl)
        calendarSegmentedControl.translatesAutoresizingMaskIntoConstraints = false
        calendarSegmentedControl.widthAnchor.constraint(equalToConstant: 114).isActive = true
        calendarSegmentedControl.centerXAnchor.constraint(equalTo: self.view.centerXAnchor).isActive = true
        calendarSegmentedControl.topAnchor.constraint(equalTo: self.view.topAnchor, constant: 60).isActive = true
...
//        writeButton.trailingAnchor.constraint(equalTo: self.view.trailingAnchor, constant: -23).isActive = true
//        writeButton.bottomAnchor.constraint(equalTo: self.view.bottomAnchor, constant: -37).isActive = true
    ...
    private lazy var floatingButton: UIButton = {
        ...
        config.image = UIImage(named: "floating")
...
extension ListViewController: FSCalendarDelegate {
    ...
    func calendarCurrentPageDidChange(_ calendar: FSCalendar) {
        ...
        df.locale = Locale(identifier: "ko_KR")
        df.dateFormat = "yyyy. MM"
        self.monthLabel.text = df.string(from: calendar.currentPage)
    }
